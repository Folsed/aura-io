...
const ShaderCanvas = () => {
    ...
    useEffect(() => {
        ...
        const positionLocation = gl.getAttribLocation(fancyShaderProgram, 'a_position')
        ...
        const prevTextureLocation = gl.getUniformLocation(fadeShaderProgram, 'u_prevTexture')
        const nextTextureLocation = gl.getUniformLocation(fadeShaderProgram, 'u_nextTexture')
        const resolutionLocation = gl.getUniformLocation(fancyShaderProgram, 'u_resolution')
        ...
        const render = () => {
            ...
            gl.useProgram(fancyShaderProgram)
            gl.uniform2fv(resolutionLocation, [gl.drawingBufferWidth, gl.drawingBufferHeight])
